    ...
    Tables: {
      ...
      review_history: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "review_history_short_answer_id_fkey"
            columns: ["short_answer_id"]
            isOneToOne: false
            referencedRelation: "short_answer_questions"
            referencedColumns: ["id"]
          },
          {
      ...
      short_answer_questions: {
        ...
        Relationships: [
          {
            foreignKeyName: "short_answer_questions_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "topics"
            referencedColumns: ["id"]
